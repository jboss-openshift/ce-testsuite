...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/openshift-examples/${template.branch:master}/demos/sso/sso70-eap64-all-in-one-demo.json",
