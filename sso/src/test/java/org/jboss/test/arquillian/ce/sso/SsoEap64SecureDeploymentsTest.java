...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/eap/eap64-sso-s2i.json",
		...
		parameters = {
    			...
    			@TemplateParameter(name = "SSO_URL", value = "https://secure-sso.cloudapps.example.com/auth"),
...
public class SsoEap64SecureDeploymentsTest extends SsoEapSecureDeploymentsTest
{
	@RouteURL("eap-app")
