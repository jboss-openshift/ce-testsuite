...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/openshift-examples/${template.branch:master}/demos/sso/sso71-eap70-all-in-one-demo.json",
