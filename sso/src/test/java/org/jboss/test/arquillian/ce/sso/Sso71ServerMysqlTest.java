...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/sso/sso71-mysql.json",
...
public class Sso71ServerMysqlTest extends SsoServerTestBase
{
	@RouteURL("sso")
