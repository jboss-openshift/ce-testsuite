...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/eap/eap70-mongodb-persistent-s2i.json", parameters = {
...
public class Eap70MongoDbPersistentTest extends EapPersistentTestBase {
