...
@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/eap/eap70-postgresql-s2i.json", parameters = {
...
public class Eap70PostgresqlTest extends EapDbTestBase {
}
