...
@Template(url = "https://raw.githubusercontent.com/${template.repository}/application-templates/${template.branch}/processserver/processserver63-amq-postgresql-persistent-s2i.json", parameters = {
