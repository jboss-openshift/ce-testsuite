...
@Template(url = "https://raw.githubusercontent.com/jboss-openshift/application-templates/master/decisionserver/decisionserver62-basic-s2i.json",
		...
		parameters = {
        @TemplateParameter(name = "KIE_SERVER_USER", value="kieserver"),
        @TemplateParameter(name = "KIE_SERVER_PASSWORD", value="Redhat@123")})
@OpenShiftResources({
...
public class DecisionServerBasicTest {
    ...
    private static KieServicesConfiguration kieServicesConfiguration;  
    ...
    public static WebArchive getDeployment() {
        ...
        war.addAsLibraries(
                Maven.resolver()
                        .resolve("org.kie:kie-server-client:6.2.0.Final")
                        .withTransitivity()
                        .asFile());
        return war;
    }
    ...
    /*
     * Verifies the server capabilities, for decisionserver-openshift:6.2 it should be BRM KieServer
     */
    @Test
    @RunAsClient
    public void testDecisionServerStatus() throws Exception {
    	...
    	kieServicesClient = getKieServiceClient(HOST);
    ...
    public static KieServicesClient getKieServiceClient(String host){
    	...
    	kieServicesConfiguration = KieServicesFactory.newRestConfiguration(host, USERNAME, PASSWORD);  
    ...
    public static void main (String args[]){
    	...
    	System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    	String host = "http://kie-app-fspolti.router.default.svc.cluster.local/kie-server/services/rest/server/";
        ...
        System.out.println(serverCapabilitiesResult);  
    }
}