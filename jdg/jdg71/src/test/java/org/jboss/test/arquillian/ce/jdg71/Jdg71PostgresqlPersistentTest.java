...
@Template(url = "https://raw.githubusercontent.com/bdecoste/application-templates/cloud-1813/datagrid/datagrid71-postgresql-persistent.json",
          parameters = {
              @TemplateParameter(name = "HTTPS_NAME", value="jboss"),
              @TemplateParameter(name = "HTTPS_PASSWORD", value="mykeystorepass"),
              @TemplateParameter(name = "REST_ENCRYPTION", value="true")
              })
...
public class Jdg71PostgresqlPersistentTest extends Jdg71TestSecureBase {
    private static final Logger log = Logger.getLogger(Jdg71PostgresqlPersistentTest.class.getName());
