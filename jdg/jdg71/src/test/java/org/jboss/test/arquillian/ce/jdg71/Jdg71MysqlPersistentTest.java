...
@Template(url = "https://raw.githubusercontent.com/bdecoste/application-templates/cloud-1813/datagrid/datagrid71-mysql-persistent.json",
          parameters = {
...
public class Jdg71MysqlPersistentTest extends Jdg71TestSecureBase {
    private static final Logger log = Logger.getLogger(Jdg71MysqlPersistentTest.class.getName());
