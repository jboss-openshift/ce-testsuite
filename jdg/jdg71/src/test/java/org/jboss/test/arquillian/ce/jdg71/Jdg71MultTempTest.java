...
import org.jboss.test.arquillian.ce.jdg71.query.support.Car;
import org.jboss.test.arquillian.ce.jdg71.query.support.CarMarshaller;
import org.jboss.test.arquillian.ce.jdg71.query.support.CarType;
import org.jboss.test.arquillian.ce.jdg71.query.support.CarTypeMarshaller;
import org.jboss.test.arquillian.ce.jdg71.query.support.Country;
import org.jboss.test.arquillian.ce.jdg71.query.support.CountryMarshaller;
...
@TemplateResources(syncInstantiation = true, templates = {
		@Template(url = "https://raw.githubusercontent.com/bdecoste/application-templates/cloud-1813/datagrid/datagrid71-basic.json", parameters = {
		...
		@Template(url = "https://raw.githubusercontent.com/${template.repository:jboss-openshift}/application-templates/${template.branch:master}/eap/eap64-basic-s2i.json", parameters = {
				@TemplateParameter(name = "SOURCE_REPOSITORY_URL", value = "https://github.com/bdecoste/openshift-quickstarts"),
				@TemplateParameter(name = "SOURCE_REPOSITORY_REF", value = "cloud-1813"),
...
public class Jdg71MultTempTest {
